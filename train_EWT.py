...
print('Metrics saved in data/EWT-training_metrics.csv')
reports_df.to_csv('data/EWT-training-report.csv', index=False)
print('Report by label saved in data/EWT-training-report.csv')
model.save_pretrained("EWT-baseline")
print('Model saved as EWT-baseline')
tokenizer.save_pretrained('EWT-tokenizer')
print('Tokenizer saved as EWT-tokenizer')
