...
print('First training EWT model')
...
#print(reports_df)
print('trained EWT baseline model')


print('training on LOTR data on top of EWT baseline model')
...
# Count initial tag occurrences in test_tags
initial_tag_counts = count_tags(test_tags)
print("Tag counts in test_tags:", dict(initial_tag_counts))
